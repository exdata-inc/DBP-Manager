...
const PATH_NAME = C.READ_DEMANDS;


export default function ReadDemand() {
  ...
  const add_new = async () => {
    ...
    const fetch_res = await (await fetch(`${tableData.urlPrefix}${C.API_ROOT_PATH}/${PATH_NAME}/?format=json`, {
      ...
      body: JSON.stringify({
        [C.AT_ID]: "",
        [C.AT_TYPE]: "dbp:RealWorldDataReadDemand",
        [C.AT_CONTEXT]: {
        ...
        "dbp:timePeriodStart": "2023-09-01T00:00:00.000000000+09:00",  // 読み込む RealWorldDataset のうち対象となるデータの開始時刻
        "dbp:timePeriodEnd": "2023-09-30T23:59:59.000000000+09:00",    // 読み込む RealWorldDataset のうち対象となるデータの終了時刻
        "dbp:sparqlQuery": "",
        "dbp:graphqlQuery": "",
    ...
    <Box sx={{ width: '100%' }}>
      <Paper sx={{ width: '100%', mb: 2 }}>
        <EnhancedTableToolbar
          ...
          helpImgSrc={`img/reading.svg`}
          helpType={'dbp:RealWorldDataReadDemand'}
        />
        <TableContainer>
          <Table
            sx={{ minWidth: 640 }}
      ...
      >
        ...
        <DialogContent>
          <Grid container spacing={2} alignItems="center" justifyContent="center" >
            ...
            <HumanFriendlyPropertyString id={id} pkey={C.DBP_SPARQL_QUERY} jsonLD={jsonLD} setJsonLD={setJsonLD} />
            <HumanFriendlyPropertyString id={id} pkey={C.DBP_GRAPHQL_QUERY} jsonLD={jsonLD} setJsonLD={setJsonLD} />
