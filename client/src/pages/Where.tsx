  ...
  const add_new = async () => {
    ...
    const fetch_res = await (await fetch(`${tableData.urlPrefix}${C.API_ROOT_PATH}/${PATH_NAME}/?format=json`, {
      ...
      body: JSON.stringify({
        ...
        "schema:address": "愛知県名古屋市千種区不老町1番",
        "schema:latitude": 35.1538553,
        "schema:longitude": 136.9682402,
        "schema:url": `https://www.ucl.nuee.nagoya-u.ac.jp/`,
    ...
    <Box sx={{ width: '100%' }}>
      <Paper sx={{ width: '100%', mb: 2 }}>
        <EnhancedTableToolbar
          ...
          helpLink='https://schema.org/Place'
        />
        <TableContainer>
          <Table
            sx={{ minWidth: 640 }}
      ...
      >
        ...
        <DialogContent>
          <Grid container spacing={2} alignItems="center" justifyContent="center" >
            ...
            <HumanFriendlyPropertyString id={id} pkey={C.AT_TYPE} jsonLD={jsonLD} setJsonLD={setJsonLD} />
            <HumanFriendlyPropertyString id={id} pkey={C.SC_URL} jsonLD={jsonLD} setJsonLD={setJsonLD} />
            <HumanFriendlyPropertyString id={id} pkey={C.SC_ADDRESS} jsonLD={jsonLD} setJsonLD={setJsonLD} />
            <HumanFriendlyPropertyString id={id} pkey={C.SC_IATA_CODE} jsonLD={jsonLD} setJsonLD={setJsonLD} />
            <HumanFriendlyPropertyString id={id} pkey={C.SC_ICAO_CODE} jsonLD={jsonLD} setJsonLD={setJsonLD} />
            <HumanFriendlyPropertyNumber id={id} pkey={C.SC_LATITUDE} jsonLD={jsonLD} setJsonLD={setJsonLD} />
            <HumanFriendlyPropertyNumber id={id} pkey={C.SC_LONGITUDE} jsonLD={jsonLD} setJsonLD={setJsonLD} />
