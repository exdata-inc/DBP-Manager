...
const headCells: readonly HeadCell[] = [
  ...
  {
    id: C.DBP_OUTPUT_TYPE,
    numeric: false,
    disablePadding: false,
    label: '出力の型',
  },
  {
    id: C.DBP_OUTPUT_CHARACTERISTIC,
    numeric: false,
    disablePadding: false,
    label: '出力データの特徴',
  },
...
const PATH_NAME = C.BREWER_OUTPUT;


export default function BrewerOutput() {
  ...
  const add_new = async () => {
    ...
    const fetch_res = await (await fetch(`${tableData.urlPrefix}${C.API_ROOT_PATH}/${PATH_NAME}/?format=json`, {
      ...
      body: JSON.stringify({
        [C.AT_ID]: "",
        [C.AT_TYPE]: "dbp:RealWorldDataBrewerOutput",
        [C.AT_CONTEXT]: {
        ...
        "dbp:outputCharacteristic": 1,   // QUANTITATIVE
    ...
    <Box sx={{ width: '100%' }}>
      <Paper sx={{ width: '100%', mb: 2 }}>
        <EnhancedTableToolbar
          ...
          helpType={'dbp:RealWorldDataBrewerOutput'}
        />
        <TableContainer>
          <Table
            sx={{ minWidth: 640 }}
              ...
              {visibleRows.map((row: any, idx: number) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell>{getLDLink(row[C.DBP_OUTPUT_TYPE], tableData.urlPrefix)}</TableCell>
                    <TableCell>{row[C.DBP_OUTPUT_CHARACTERISTIC]}</TableCell>
      ...
      >
        ...
        <DialogContent>
          <Grid container spacing={2} alignItems="center" justifyContent="center" >
            ...
            <HumanFriendlyDictProperty id={id} pkey={C.DBP_OUTPUT_TYPE} path="" urlPrefix="" jsonLD={jsonLD} setJsonLD={setJsonLD} />
            <HumanFriendlyPropertyNumberOrString id={id} pkey={C.SC_VALUE} jsonLD={jsonLD} setJsonLD={setJsonLD} />
            <HumanFriendlyPropertyNumberOrString id={id} pkey={C.DBP_OUTPUT_CHARACTERISTIC} jsonLD={jsonLD} setJsonLD={setJsonLD} />
