...
const PATH_NAME = C.COLLECTION_DEMANDS;


export default function CollectionDemands() {
  ...
  const add_new = async () => {
    ...
    const fetch_res = await (await fetch(`${tableData.urlPrefix}${C.API_ROOT_PATH}/${PATH_NAME}/?format=json`, {
      ...
      body: JSON.stringify({
        [C.AT_ID]: "",
        [C.AT_TYPE]: "dbp:RealWorldDataCollectionDemand",
        [C.AT_CONTEXT]: {
    ...
    <Box sx={{ width: '100%' }}>
      <Paper sx={{ width: '100%', mb: 2 }}>
        <EnhancedTableToolbar
          ...
          helpType={'dbp:RealWorldDataCollectionDemand'}
        />
        <TableContainer>
          <Table
            sx={{ minWidth: 640 }}
      ...
      >
        ...
        <DialogContent>
          <Grid container spacing={2} alignItems="center" justifyContent="center" >
            ...
            <HumanFriendlyPropertySingleSelect id={id} pkey={C.DBP_COLLECTION_INFO} path={C.COLLECTION_INFO} urlPrefix={props.urlPrefix} jsonLD={jsonLD} setJsonLD={setJsonLD} />
