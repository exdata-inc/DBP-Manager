...
const PATH_NAME = C.REGISTER_DEMANDS;


export default function RegisterDemand() {
    ...
    <Box sx={{ width: '100%' }}>
      <Paper sx={{ width: '100%', mb: 2 }}>
        <EnhancedTableToolbar
          ...
          helpType={'dbp:RealWorldDataRegisterDemand'}
        />
        <TableContainer>
          <Table
            sx={{ minWidth: 640 }}
      ...
      >
        ...
        <DialogContent>
          <Grid container spacing={2} alignItems="center" justifyContent="center" >
            ...
            <HumanFriendlyPropertySingleSelect id={id} pkey={C.SC_DATASET} path={C.DATASET} urlPrefix={props.urlPrefix} jsonLD={jsonLD} setJsonLD={setJsonLD} />
