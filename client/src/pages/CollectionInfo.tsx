...
import { HumanFriendlyPropertyReadOnly, HumanFriendlyDictProperty, HumanFriendlyPropertyMultipleSelect, HumanFriendlyPropertySingleSelect, HumanFriendlyPropertyString, HumanFriendlyInPropertyString } from '../components/HumanFriendlyEditors';
...
const PATH_NAME = C.COLLECTION_INFO;
  ...
  const add_new = async () => {
    ...
    const fetch_res = await (await fetch(`${tableData.urlPrefix}${C.API_ROOT_PATH}/${PATH_NAME}/?format=json`, {
      ...
      body: JSON.stringify({
        ...
        "dbp:collectionStyle": "Proxy",
        "dbp:collectionProtocol": "TCP",
        "schema:entryPoint": {
          "schema:url":"localhost:3000",
          "schema:actionApplication":"none"
        },
        "dbp:listenAddress": "0.0.0.0:3010",
        "dbp:serverAddress": "192.168.1.2:8080",
    ...
    <Box sx={{ width: '100%' }}>
      <Paper sx={{ width: '100%', mb: 2 }}>
        <EnhancedTableToolbar
          ...
          helpType={'dbp:RealWorldDataCollectionInfo'}
        />
        <TableContainer>
          <Table
            sx={{ minWidth: 640 }}
              ...
              {visibleRows.map((row: any, idx: number) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell>{row['dbp:collectionStyle']}</TableCell>
                    <TableCell>{row['dbp:collectionProtocol']}</TableCell>
      ...
      >
        ...
        <DialogContent>
          <Grid container spacing={2} alignItems="center" justifyContent="center" >
            ...
            <HumanFriendlyPropertyString id={id} pkey={C.DBP_LISTEN_ADDRESS} jsonLD={jsonLD} setJsonLD={setJsonLD} />
            <HumanFriendlyPropertyString id={id} pkey={C.DBP_SERVER_ADDRESS} jsonLD={jsonLD} setJsonLD={setJsonLD} />
            <HumanFriendlyPropertyString id={id} pkey={C.DBP_COLLECTION_STYLE} jsonLD={jsonLD} setJsonLD={setJsonLD} />
            <HumanFriendlyPropertyString id={id} pkey={C.DBP_COLLECTION_PROTOCOL} jsonLD={jsonLD} setJsonLD={setJsonLD} />
