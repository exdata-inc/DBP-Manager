...
const PATH_NAME = C.WRITE_DEMANDS;


export default function WriteDemand() {
  ...
  const add_new = async () => {
    ...
    const fetch_res = await (await fetch(`${tableData.urlPrefix}${C.API_ROOT_PATH}/${PATH_NAME}/?format=json`, {
      ...
      body: JSON.stringify({
        [C.AT_ID]: "",
        [C.AT_TYPE]: "dbp:RealWorldDataWriteDemand",
        [C.AT_CONTEXT]: {
          "dbp": "https://exdata.co.jp/dbp/schema/",
          "schema": "https://schema.org/"
        },
        "schema:name": `新規${t(`path.${PATH_NAME}`)}`,
        "dbp:timePeriodStart": "2023-09-01T00:00:00.000000000+09:00",  // 書き込む RealWorldDataset のうち対象となるデータの開始時刻
        "dbp:timePeriodEnd": "2023-09-30T23:59:59.000000000+09:00",    // 書き込む RealWorldDataset のうち対象となるデータの終了時刻
    ...
    <Box sx={{ width: '100%' }}>
      <Paper sx={{ width: '100%', mb: 2 }}>
        <EnhancedTableToolbar
          ...
          helpType={'dbp:RealWorldDataWriteDemand'}
        />
        <TableContainer>
          <Table
            sx={{ minWidth: 640 }}
      ...
      >
        ...
        <DialogContent>
          <Grid container spacing={2} alignItems="center" justifyContent="center" >
            ...
            <HumanFriendlyPropertyNumber id={id} pkey={C.DBP_DATA} jsonLD={jsonLD} setJsonLD={setJsonLD} />
