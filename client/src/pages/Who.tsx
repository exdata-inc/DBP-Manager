    ...
    <Box sx={{ width: '100%' }}>
      <Paper sx={{ width: '100%', mb: 2 }}>
        <EnhancedTableToolbar
          ...
          helpLink='https://schema.org/Organization'
        />
        <TableContainer>
          <Table
            sx={{ minWidth: 640 }}
      ...
      >
        ...
        <DialogContent>
          <Grid container spacing={2} alignItems="center" justifyContent="center" >
            ...
            <HumanFriendlyPropertyString id={id} pkey={C.SC_LOCATION} jsonLD={jsonLD} setJsonLD={setJsonLD} />
            <HumanFriendlyPropertyString id={id} pkey={C.SC_DEPARTMENT} jsonLD={jsonLD} setJsonLD={setJsonLD} />
