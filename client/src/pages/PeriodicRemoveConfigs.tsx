...
const PATH_NAME = C.PERIODIC_REMOVE_CONFIGS;


export default function PeriodicRemoveConfigs() {
  ...
  const add_new = async () => {
    ...
    const fetch_res = await (await fetch(`${tableData.urlPrefix}${C.API_ROOT_PATH}/${PATH_NAME}/?format=json`, {
      ...
      body: JSON.stringify({
        [C.AT_ID]: "",
        [C.AT_TYPE]: "dbp:RealWorldDataPeriodicRemoveConfig",
        [C.AT_CONTEXT]: {
        ...
        "dbp:removeConfig": {
          [C.AT_ID]: tableData.urlPrefix + "/api/v0/remove_demands/*/?format=json",
    ...
    <Box sx={{ width: '100%' }}>
      <Paper sx={{ width: '100%', mb: 2 }}>
        <EnhancedTableToolbar
          ...
          helpImgSrc={`img/removing.svg`}
          helpType={'dbp:RealWorldDataPeriodicRemoveConfig'}
        />
        <TableContainer>
          <Table
            sx={{ minWidth: 640 }}
              ...
              {visibleRows.map((row: any, idx: number) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell>{getLDLink(row['dbp:removeConfig'], tableData.urlPrefix)}</TableCell>
      ...
      >
        ...
        <DialogContent>
          <Grid container spacing={2} alignItems="center" justifyContent="center" >
            ...
            <HumanFriendlyPropertySingleSelect id={id} pkey={C.DBP_REMOVE_CONFIG} path={C.REMOVE_DEMANDS} urlPrefix={props.urlPrefix} jsonLD={jsonLD} setJsonLD={setJsonLD} />
