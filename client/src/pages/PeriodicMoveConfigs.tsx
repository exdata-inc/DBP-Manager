...
const PATH_NAME = C.PERIODIC_MOVE_CONFIGS;


export default function PeriodicMoveConfigs() {
  ...
  const add_new = async () => {
    ...
    const fetch_res = await (await fetch(`${tableData.urlPrefix}${C.API_ROOT_PATH}/${PATH_NAME}/?format=json`, {
      ...
      body: JSON.stringify({
        [C.AT_ID]: "",
        [C.AT_TYPE]: "dbp:RealWorldDataPeriodicMoveConfig",
        [C.AT_CONTEXT]: {
        ...
        "dbp:moveConfig": {
          [C.AT_ID]: tableData.urlPrefix + "/api/v0/move_demands/*/?format=json",
    ...
    <Box sx={{ width: '100%' }}>
      <Paper sx={{ width: '100%', mb: 2 }}>
        <EnhancedTableToolbar
          ...
          helpType={'dbp:RealWorldDataPeriodicMoveConfig'}
        />
        <TableContainer>
          <Table
            sx={{ minWidth: 640 }}
              ...
              {visibleRows.map((row: any, idx: number) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell>{getLDLink(row['dbp:moveConfig'], tableData.urlPrefix)}</TableCell>
      ...
      >
        ...
        <DialogContent>
          <Grid container spacing={2} alignItems="center" justifyContent="center" >
            ...
            <HumanFriendlyPropertySingleSelect id={id} pkey={C.DBP_MOVE_CONFIG} path={C.MOVE_DEMANDS} urlPrefix={props.urlPrefix} jsonLD={jsonLD} setJsonLD={setJsonLD} />
