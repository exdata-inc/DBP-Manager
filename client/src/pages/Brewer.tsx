    ...
    <Box sx={{ width: '100%' }}>
      <Paper sx={{ width: '100%', mb: 2 }}>
        <EnhancedTableToolbar
          ...
          helpType={'dbp:RealWorldDataBrewerInfo'}
        />
        <TableContainer>
          <Table
            sx={{ minWidth: 640 }}
      ...
      >
        ...
        <DialogContent>
          <Grid container spacing={2} alignItems="center" justifyContent="center" >
            ...
            <HumanFriendlyPropertyMultipleSelect id={id} pkey={C.DBP_ARG_SPECS} path={C.BREWER_ARGUMENT} jsonLD={jsonLD} setJsonLD={setJsonLD} urlPrefix={props.urlPrefix} />
            <HumanFriendlyPropertyMultipleSelect id={id} pkey={C.DBP_INPUT_SPECS} path={C.BREWER_INPUT} jsonLD={jsonLD} setJsonLD={setJsonLD} urlPrefix={props.urlPrefix} />
            <HumanFriendlyPropertyMultipleSelect id={id} pkey={C.DBP_OUTPUT_SPECS} path={C.BREWER_OUTPUT} jsonLD={jsonLD} setJsonLD={setJsonLD} urlPrefix={props.urlPrefix} />
            <HumanFriendlyPropertyNumberOrString id={id} pkey={C.DBP_CONVERSION_CHARACTERISTIC} jsonLD={jsonLD} setJsonLD={setJsonLD} />
