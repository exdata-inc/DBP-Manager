...
const headCells: readonly HeadCell[] = [
  ...
  },
  {
    ...
    numeric: false,
    disablePadding: false,
    label: '引数の値（具体的な需要に紐づくエントリのみ）',
  },
];

const PATH_NAME = C.BREWER_ARGUMENT;

export default function BrewerArgument() {
    ...
    <Box sx={{ width: '100%' }}>
      <Paper sx={{ width: '100%', mb: 2 }}>
        <EnhancedTableToolbar
          ...
          helpType={'dbp:RealWorldDataBrewerArgument'}
        />
        <TableContainer>
          <Table
            sx={{ minWidth: 640 }}
              ...
              {visibleRows.map((row: any, idx: number) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell>{row['dbp:key']}</TableCell>
                    <TableCell>{row['dbp:argumentType'][C.AT_ID]}</TableCell>
                    <TableCell>{row['schema:value']}</TableCell>
      ...
      >
        ...
        <DialogContent>
          <Grid container spacing={2} alignItems="center" justifyContent="center" >
            ...
            <HumanFriendlyDictProperty id={id} pkey={C.DBP_ARGUMENT_TYPE} path="" urlPrefix="" jsonLD={jsonLD} setJsonLD={setJsonLD} />
